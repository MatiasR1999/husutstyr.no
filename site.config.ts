...
const site = {
  ...
  tokens: {
    ...
    '--text-minorheading': '1.125rem', '--thumb-width': '10rem',
  },
  ...
  ui: { skip: 'Til innholdet', photo: 'Foto', photoSource: 'Pexels', menu: 'Meny', home: 'Forside', category: 'Kategori', read: 'Les artikkelen', contents: 'Til kontrollpunktet', published: 'Publisert', modified: 'Sist oppdatert', author: 'Forfatter', notFound: 'Siden finnes ikke', back: 'Tilbake til forsiden', breadcrumb: 'Brødsmuler' },
