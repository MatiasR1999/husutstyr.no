...
const site = {
  ...
  consent: {
    ...
    ui: {
      ...
      description: 'Husutstyr måler ingenting før du sier ja. Sier du ja, teller vi sidevisninger, hvor raskt sidene laster, og hvilke annonselenker som blir klikket. Svaret ditt lagres i 180 dager, og du kan snu når som helst under Personvernvalg nederst.',
  ...
  affiliate: { allowedOrigins: [], disclosure: 'Reklame: Noen lenker på denne siden er annonselenker. Handler du gjennom dem, kan Husutstyr få provisjon. Prisen din blir ikke høyere.', ownedDisclosure: 'Reklame: Denne lenken går til en butikk utgiveren av Husutstyr eier selv.', linkLabel: 'Annonselenke', ownedLinkLabel: 'Reklame: Egen butikk' },
