...
if(process.env.MIGRATION_EMPTY_CHECK==='true') connection.pathname='/phase3_migration_qa';
...
try {
 ...
 await writeFile(process.env.MIGRATION_EMPTY_CHECK==='true'?'docs/qa/phase3/migrations-empty.json':'docs/qa/phase3/migrations.json',JSON.stringify(report,null,2)+'\n');
