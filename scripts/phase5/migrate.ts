...
if(process.env.MIGRATION_EMPTY_CHECK==='true') connection.pathname='/phase5_migration_qa';
...
try {
 ...
 await writeFile(process.env.MIGRATION_EMPTY_CHECK==='true'?'docs/qa/phase5/migrations-empty.json':'docs/qa/phase5/migrations.json',JSON.stringify(report,null,2)+'\n');
