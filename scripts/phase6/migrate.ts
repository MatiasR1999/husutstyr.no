...
if(process.env.MIGRATION_EMPTY_CHECK==='true') connection.pathname='/phase6_migration_qa';
...
try {
 ...
 await writeFile(process.env.MIGRATION_EMPTY_CHECK==='true'?'docs/qa/phase6/migrations-empty.json':'docs/qa/phase6/migrations.json',JSON.stringify(report,null,2)+'\n');
